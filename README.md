...
- CSS
- JavaScript
- Integração com a API Open Library

🔎 Funcionalidades
- Busca de livros pelo título
- Exibição de informações dos livros (autor, capa, descrição, etc.)
- Consumo de dados em tempo real através de API

📖 API utilizada
- Os dados dos livros são obtidos através da API pública da Open Library, que disponibiliza um grande catálogo de obras literárias.
